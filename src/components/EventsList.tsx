    ...
    <section className="snap-section relative min-h-dvh flex flex-col justify-center py-16 px-6 sm:px-10">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <ul
          ...
          className="border-t border-[#E6E6E6] dark:border-neutral-800"
        >
          {EVENTS.map((ev, i) => (
            <li
              ...
              className="group border-b border-[#E6E6E6] dark:border-neutral-800 cursor-pointer"
              style={{
            ...
            >
              <div className="flex items-center justify-between gap-6 py-5 sm:py-7">
                <div className="flex items-baseline gap-4 sm:gap-8 min-w-0">
                  <span className="font-mono font-extrabold text-[#0084FF] dark:text-sky-300 text-xs sm:text-sm tracking-wider tabular-nums shrink-0 w-[52px] sm:w-[64px]">
                    {ev.date}
                  </span>
                  <h3 className="font-sans font-black uppercase tracking-tight text-[#1A1A1A] dark:text-[#F2F2F2] text-2xl sm:text-4xl lg:text-5xl leading-none truncate transition-transform duration-300 group-hover:translate-x-2 sm:group-hover:translate-x-5">
                    {ev.title}
                  </h3>
                </div>
                <div className="flex items-center gap-4 sm:gap-6 shrink-0">
                  ...
                  <ArrowUpRight className="h-5 w-5 sm:h-6 sm:w-6 text-neutral-400 group-hover:text-[#0084FF] dark:group-hover:text-sky-300 group-hover:translate-x-1 group-hover:-translate-y-1 transition-all" />
                </div>
              </div>
            </li>
          ))}
